...
<link type="text/css" rel=stylesheet href="CSS/Booklist.css">
	...
	<div class="sn-container">
      	<p id="login-info" class="sn-login-info">
      		...
      		<% 
      			...
      			if(islogin){
      				out.print("<a class=\"sn-login\" href=\"login.jsp\">登录</a>&nbsp;&nbsp;");
      		    	out.print("<a class=\"sn-register\" href=\"register.jsp\">注册</a>");
      			}else{
	     ...
	     <ul class="sn-quick-menu">
	     	<li class="sn-cart">
	     		<a class="sn-cart-link" href="bookCart.jsp" onClick="linkCart()">购物车</a>
	     	</li>
	     	<li class="sn-order">
	     		<a class="sn-order-link" href="order.jsp" onClick="linkCart()">订单</a>
	     	</li>
	     	<li class="sn-message">
	     		<a class="sn-message-link" href="message.jsp">留言</a>
	     	</li>
	     </ul>
      </div>
      <br>
<table class="body">
 <%
    ...
    while(rs!=null && rs.next()){
    	...
    	out.print("<tr><td><a href=\"xiangqing.jsp?bookid="+bookid+"\"><img src=\""+bookpicPath+"\" alt=\"书籍图片\" /></a></td>");
